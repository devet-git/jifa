      ...
      <div className="px-8 pt-4 pb-0 border-b border-border bg-surface shrink-0">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            {project?.description && (
              <p className="text-[11px] text-muted truncate">{project.description}</p>
            )}
          </div>
          <button
            onClick={() => setShowPerms(true)}
            className="inline-flex items-center gap-1 text-[11px] text-muted hover:text-foreground hover:bg-surface-2 px-2 py-1 rounded-lg transition"
            title="Xem quyền của tôi"
          >
